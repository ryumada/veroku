...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('btn-load-example-data')?.addEventListener('click', () => {
    ...
    activeVeh.services = [
      { id: generateId('srv'), name: 'Rantai Roda - Periksa & Lumasi (PL)', interval_km: 500, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 450, interval_time_val: 1, interval_time_unit: 'weeks', warning_time_val: 6, warning_time_unit: 'days', notes: 'Bersihkan dengan WD-40 lalu lumasi dengan oli gardan 80W-90' },
      {
        id: generateId('srv'), name: 'Oli Mesin - Ganti (G)', interval_km: 3500, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3250, interval_time_val: 6, interval_time_unit: 'months', warning_time_val: 5, warning_time_unit: 'months', notes: 'Gunakan oli mesin 10W-40 Enduro Racing 4T, Shell Advance X7. Spesifikasi oli:\n\n● Standar JASO T 903*1: MA\n\n● Standar SAE*2: 10W- 30\n\n● Klasifikasi API * 3: SJ atau lebih tinggi.'
      },
      { id: generateId('srv'), name: 'Saluran Bahan Bakar - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months', notes: 'Coba cek mandiri dulu di Youtube.' },
      { id: generateId('srv'), name: 'Cara Kerja Gas Tangan - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 6, interval_time_unit: 'months', warning_time_val: 5, warning_time_unit: 'months', notes: 'Putar gas tangan dari posisi tertutup hingga terbuka penuh pada semua posisi setang kemudi (belok kanan/kiri penuh). Pastikan gas tangan dapat menutup kembali secara otomatis dengan lancar.\n\nSpesifikasi: Jarak bebas putaran gas tangan yang ideal adalah 2–6 mm.\n\nReferensi Buku Pedoman Pemilik (BPP): Hal. 66 (71 PDF - Cara Pemeriksaan Jarak Bebas Putaran Gas).' },
      ...
      { id: generateId('srv'), name: 'Putaran Stasioner Mesin - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months' },
      { id: generateId('srv'), name: 'Minyak Rem - Periksa', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500 },
      {
        id: generateId('srv'), name: 'Minyak Rem - Ganti Berkala', interval_km: 24000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 23500, interval_time_val: 2, interval_time_unit: 'years', warning_time_val: 23, warning_time_unit: 'months', notes: 'Ganti oli rem setiap 2 tahun sekali agar kinerja rem tetap optimal. Minyak Rem Honda DOT 3 atau DOT 4 atau yang setara.'
      },
      { id: generateId('srv'), name: 'Keausan Kampas Rem - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months' },
      { id: generateId('srv'), name: 'Sistem Rem - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months', notes: 'Coba cek mandiri dulu di Youtube.' },
      { id: generateId('srv'), name: 'Sakelar Lampu Rem - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months' },
      { id: generateId('srv'), name: 'Arah Sinar Lampu Depan - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months' },
      ...
      { id: generateId('srv'), name: 'Standar Samping - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months', notes: 'Cek buku panduan hal. 61 (66 PDF Memeriksa Standar Samping)' },
      { id: generateId('srv'), name: 'Suspensi - Periksa (P)', interval_km: 4000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 3500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months' },
      { id: generateId('srv'), name: 'Mur, Baut, Pengencang - Periksa (P)', interval_km: 8000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 7500, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months' },
      ...
      { id: generateId('srv'), name: 'Saringan Udara - Ganti (Ganti atau Bersihkan)', interval_km: 16000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 15000, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months' },
      { id: generateId('srv'), name: 'Saringan Kasa Oli Mesin - Bersihkan (B)', interval_km: 12000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 11250, interval_time_val: 12, interval_time_unit: 'months', warning_time_val: 11, warning_time_unit: 'months' },
      { id: generateId('srv'), name: 'Saringan Sentrifugal Oli - Bersihkan (B)', interval_km: 12000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 11250 },
      { id: generateId('srv'), name: 'Bantalan Kepala Kemudi - Periksa (P)', interval_km: 12000, last_service_odometer: 0, last_service_date: todayStr, warning_threshold: 11250 }
    ];
